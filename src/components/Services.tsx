import rentalPromo from '../assets/images/rental-promo.jpg';
import ebike1 from '../assets/images/ebike-1.jpg';
import ebike2 from '../assets/images/ebike-2.jpg';
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Tarifas transparentes para un trabajo de primera clase. Sin sorpresas, solo resultados.
          </p>
        </div>
        ...
        <div id="rental" className={styles.rentalSection}>
          <div className={styles.rentalHeader}>
            ...
            <p className={styles.rentalDescription}>
              Descubre Oviedo y sus alrededores con nuestras bicicletas eléctricas de montaña de
              última generación. Potencia y diversión garantizada.
            </p>
          </div>

          <div className={styles.rentalGrid}>
            <img src={rentalPromo} alt="Alquiler MTB Eléctrica" className={styles.rentalImage} />
            <img src={ebike1} alt="E-Bike en la montaña" className={styles.rentalImage} />
            <img src={ebike2} alt="Ruta en bicicleta" className={styles.rentalImage} />
          </div>
